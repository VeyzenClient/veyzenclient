...
public class Panorama extends GuiScreen {
    ...
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[]{
            new ResourceLocation("veyzen", "panorama/panorama_0.png"),
            new ResourceLocation("veyzen", "panorama/panorama_1.png"),
            new ResourceLocation("veyzen", "panorama/panorama_2.png"),
            new ResourceLocation("veyzen", "panorama/panorama_3.png"),
            new ResourceLocation("veyzen", "panorama/panorama_4.png"),
            new ResourceLocation("veyzen", "panorama/panorama_5.png")
    };
